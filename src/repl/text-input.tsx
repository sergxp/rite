/**
 * Local fork of ink-text-input v6 with added ctrl+w and ctrl+u support.
    ...
    (input, key) => {
      ...
      if (key.leftArrow) {
        ...
        if (cursorOffset > 0) {
          ...
          const deleteUpto = lastSpace === -1 ? 0 : lastSpace + 1;
          nextValue =
            originalValue.slice(0, deleteUpto) +
            originalValue.slice(cursorOffset);
          nextCursorOffset = deleteUpto;
        }
      } else {
        nextValue =
